...
class MyCommentPageView extends StatefulWidget {
  const MyCommentPageView({super.key});

  @override
  State<MyCommentPageView> createState() => _MyCommentPageViewState();
}

class _MyCommentPageViewState extends State<MyCommentPageView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MAppBar(
        ...
        title: Text("My Comment", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),),
      ),
              ...
              return Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.chat_outlined, size: 70,),
                      Expanded(
                        child: Wrap(
                          children: [
